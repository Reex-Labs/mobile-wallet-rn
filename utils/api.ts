...
// import { coinToReex, reexToCoin } from './reex'
// import { Coin } from "@cosmjs/stargate/build/codec/cosmos/base/v1beta1/coin"

const seed_url = seed[0]
// let client: StargateClient
// StargateClient.connect(seed_url).then((client) => {
//   client = client
// })

export async function getBalance(address: string, denom = 'reex'): Promise<string> {
  // try {
